      ...
      <ul>
        ...
        <div class="col">
            <li class="bantin flex-col">
                <?php
                    echo "
                        <a href='tintuc_details.php?id=$id'><img src='$image' width='100%' height='auto' /></a>
                        <p class='bantin-time'><i class='fa-solid fa-clock'></i> $created_at</p>
                        <a href='tintuc_details.php?id=$id'><h2> $title </h2></a>
                        <a href='tintuc_details.php?id=$id'><h4 class='bantin-tomtat'>$content </h4></a>
                        <a href='tintuc_details.php?id=$id'><h4>Đọc thêm <i class='fa-solid fa-circle-right fa-xs'></i> </h4></a>";
                ?>
            </li>
        </div>
        <?php } ?>
