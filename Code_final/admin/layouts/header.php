...
<head>
    ...
    <title>IT-SUPPORTTER || NHOM 20</title>
    ...
    <?php if (isset($_SESSION['account_admin'])) : ?>
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        <div class="image">
                            <img src="./Public/admin/dist/img/chung.jpg" class="img-circle elevation-2" alt="User Image">
                        </div>
                        <div class="info">
                            <a href="#" class="d-block">Hoàng Chí Chung</a>
                        </div>
                    </div>
           ...
           with font-awesome or any other icon font library -->
                            ...
                            <li class="nav-item has-treeview">
                                <a href="ds_phieuyeucau.php" class="nav-link">
                                    <i class="nav-icon fas fa-copy"></i>
                                    <p>
                                        Phiếu Yêu Cầu
                                        <i class="fas fa-angle-left right"></i>
