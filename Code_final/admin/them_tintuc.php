...
<?php
    ...
    $sql_post = "SELECT * FROM blog";
    $sql_accounts="Select id from accounts";
    ...
    if(isset($_POST['sbm'])){
        ...
        $sql = "INSERT INTO blog (title, slug, image, content, accounts_id, status) VALUES ('$title', '$slug', '$image', '$content','$accounts_id', '$status')";
