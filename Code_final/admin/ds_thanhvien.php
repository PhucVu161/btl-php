            ...
            <tbody>
              <?php while ($row = mysqli_fetch_array($query)) : ?>
                <tr>
                  ...
                  <td><a href="sua_thanhvien.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">Sửa</button></a></td>
                  <td><a href="xoa_thanhvien.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Bạn có muốn xóa thành viên này?')"><button type="button" class="btn btn-danger">Xóa</button></a></td>
                </tr>
              <?php endwhile; ?>
            </tbody>
          </table>
