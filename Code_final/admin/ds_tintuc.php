...
<tr>
  ...
  <!-- <td><<?php echo $row['content']; ?><?php echo $row['content']; ?></td> -->
  <td><?php echo $row['created_at']; ?></td>
  <td><?php echo $row['updated_at']; ?></td>
  <td><?php echo $row['status']; ?></td>
  <td><a href="sua_tintuc.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">Sửa</button></a></td>
  <td><a href="xoa_tintuc.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Bạn có muốn xóa bản ghi này?')"><button type="button" class="btn btn-danger">Xóa</button></a></td>
</tr>
<?php endwhile;?>
</table>
